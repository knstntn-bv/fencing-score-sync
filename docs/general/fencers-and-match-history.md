...
2. **`/fencers`** — список, добавление, переименование, архив / restore, переключатель архивных, кнопка индивидуальной статистики. Не смешивается с лимитами в Settings.
...
6. **Settings** — лимиты на устройстве; для вошедшего — ссылки на ростер/историю и Sign out.

Навигация с табло: иконки Users / Tournaments / History / Settings. У гостя вместо клубных — Sign in.
